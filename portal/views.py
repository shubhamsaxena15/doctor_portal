...
def signup(request ):
    if request.method == 'POST':
        ...
        if data:
            ...
            en = member(users=users,firstname=firstname,lastname=lastname,username=username,email=email,image=image,phonenumber=phonenumber,password=password,confirmpassword=confirmpassword,address=address)
            en.save()
            return render(request,"signup.html")
        else:
